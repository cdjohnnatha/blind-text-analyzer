...
function GoogieSpell(img_dir, server_url) {
    ...
    this.lang_chck_spell = "Verificar";
    this.lang_revert = "Reverter";
    this.lang_close = "Fechar";
    this.lang_rsm_edt = "continuar a escrever";
    this.lang_no_error_found = "sem erros";
    this.lang_no_suggestions = "nenhuma sugestão";
...
GoogieSpell.prototype.parseResult = function(r_text) {
    ...
    for(var i=0; i < matched_c.length; i++) {
    	...
    	//alert('errors '+this.cnt_errors + " lang " +GOOGIE_CUR_LANG);
	//_gaq.push(['_trackEvent', 'Spellcheck', 'Language', GOOGIE_CUR_LANG,this.cnt_errors]);
    return results;
}
